...
featured: true
tagline: |
  When we act together, is there just one way our intentions can be shared?
  * Three theories: plural (one intention with many subjects), aggregate (a group agent with its own agenda), and reductive (a structure built from individual intentions).
  * Each fits different phenomena.
  * Living out a theory of shared intention can make it true of us.
---
